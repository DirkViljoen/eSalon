...
// PASTLWTR : 1.2
// File generated on 1/30/2011 10:40:02 AM from Type Library described below.
...
begin
  ...
  DefaultInterface.Navigate(URL, MissedParam, MissedParam, MissedParam, MissedParam);
end;
...
begin
  MissedParam := EmptyParam;
  DefaultInterface.Navigate(URL, Flags, MissedParam, MissedParam, MissedParam);
end;
...
begin
  MissedParam := EmptyParam;
  DefaultInterface.Navigate(URL, Flags, TargetFrameName, MissedParam, MissedParam);
end;
...
begin
  MissedParam := EmptyParam;
  DefaultInterface.Navigate(URL, Flags, TargetFrameName, PostData, MissedParam);
end;
...
begin
  MissedParam := EmptyParam;
  DefaultInterface.Refresh2(MissedParam);
end;
...
begin
  MissedParam := EmptyParam;
  DefaultInterface.Navigate2(URL, MissedParam, MissedParam, MissedParam, MissedParam);
end;
...
begin
  MissedParam := EmptyParam;
  DefaultInterface.Navigate2(URL, Flags, MissedParam, MissedParam, MissedParam);
end;
...
begin
  MissedParam := EmptyParam;
  DefaultInterface.Navigate2(URL, Flags, TargetFrameName, MissedParam, MissedParam);
end;
...
begin
  MissedParam := EmptyParam;
  DefaultInterface.Navigate2(URL, Flags, TargetFrameName, PostData, MissedParam);
end;
...
begin
  MissedParam := EmptyParam;
  DefaultInterface.ExecWB(cmdID, cmdexecopt, MissedParam, MissedParam);
end;
...
begin
  MissedParam := EmptyParam;
  DefaultInterface.ExecWB(cmdID, cmdexecopt, pvaIn, MissedParam);
end;
...
begin
  MissedParam := EmptyParam;
  DefaultInterface.ShowBrowserBar(pvaClsid, MissedParam, MissedParam);
end;
...
begin
  MissedParam := EmptyParam;
  DefaultInterface.ShowBrowserBar(pvaClsid, pvarShow, MissedParam);
end;
